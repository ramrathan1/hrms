...
export const ROUTE_DATA: Record<string, string[]> = {
  ...
  "/hr/leaves": ["leaves", "leaveQuota"],
  "/hr/shifts": ["shifts"],
  "/knowledge": ["kbArticles"],
  // Your own file: the entitlement panel reads the quota rows, so the page has
  // to ask for them — it showed "no entitlement yet" for everyone otherwise.
  "/profile": ["leaves", "leaveQuota"],
  ...
  "/portal/me": ["applications", "clients", "expenses", "interviews", "invoices", "jobs", "leaves", "leaveQuota", "milestones", "projects", "tasks", "tickets", "timeLogs"],
